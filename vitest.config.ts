...
export default defineConfig({
  resolve: {
    // Keep this ordered: the base `genoma/plugin-sdk` alias is a prefix match.
    alias: [
      {
        find: "genoma/plugin-sdk/account-id",
        replacement: path.join(repoRoot, "src", "plugin-sdk", "account-id.ts"),
      },
      {
        find: "genoma/plugin-sdk/keyed-async-queue",
        replacement: path.join(repoRoot, "src", "plugin-sdk", "keyed-async-queue.ts"),
      },
      {
        find: "genoma/plugin-sdk",
