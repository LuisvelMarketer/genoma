...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "genoma/plugin-sdk";
...
import { resolvePreferredGenomaTmpDir } from "../../../src/infra/tmp-genoma-dir.js";
import {
  type MSTeamsAdapter,
...
describe("msteams messenger", () => {
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(path.join(resolvePreferredGenomaTmpDir(), "msteams-mention-"));
