...
import { registerAcpRuntimeBackend, unregisterAcpRuntimeBackend } from "genoma/plugin-sdk";
...
export function createAcpxRuntimeService(
  ...
  return {
    id: "acpx-runtime",
    async start(ctx: GenomaPluginServiceContext): Promise<void> {
    ...
    async stop(_ctx: GenomaPluginServiceContext): Promise<void> {
      lifecycleRevision += 1;
