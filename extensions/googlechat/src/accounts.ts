...
export function listGoogleChatAccountIds(cfg: GenomaConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: GenomaConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: GenomaConfig): ResolvedGoogleChatAccount[] {
