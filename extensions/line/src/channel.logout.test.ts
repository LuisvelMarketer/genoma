import type { GenomaConfig, PluginRuntime, ResolvedLineAccount } from "genoma/plugin-sdk";
...
function createRuntime(): { runtime: PluginRuntime; mocks: LineRuntimeMocks } {
  ...
  const resolveLineAccount = vi.fn(
    ({ cfg, accountId }: { cfg: GenomaConfig; accountId?: string }) => {
...
async function runLogoutScenario(params: { cfg: GenomaConfig; accountId: string }): Promise<{
