...
import type { ReplyPayload, GenomaConfig } from "genoma/plugin-sdk";
import { createReplyPrefixOptions } from "genoma/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as GenomaConfig;
