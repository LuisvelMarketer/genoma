...
Nostr DM channel plugin for Genoma using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Genoma. It enables your bot to:
...
# Configure genoma to use local relay
