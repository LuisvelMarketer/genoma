...
function resolveConfiguredDefaultNostrAccountId(cfg: GenomaConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: GenomaConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: GenomaConfig): string {
