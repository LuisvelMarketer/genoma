...
import { resolveChannelMediaMaxBytes, type GenomaConfig } from "genoma/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: GenomaConfig; accountId?: string }): string[] {
