...
export function listBlueBubblesAccountIds(cfg: GenomaConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: GenomaConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: GenomaConfig): ResolvedBlueBubblesAccount[] {
