...
This directory contains the **BlueBubbles external channel plugin** for Genoma.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `genoma/plugin-sdk` helpers.
