...
export function listZalouserAccountIds(cfg: GenomaConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: GenomaConfig): string {
...
function mergeZalouserAccountConfig(cfg: GenomaConfig, accountId: string): ZalouserAccountConfig {
