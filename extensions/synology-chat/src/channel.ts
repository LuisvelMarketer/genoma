/**
 * Synology Chat Channel Plugin for Genoma.
 *
...
export function createSynologyChatPlugin() {
  return {
    ...
    meta: {
      ...
      blurb: "Connect your Synology NAS Chat to Genoma",
      order: 90,
    },
    ...
    pairing: {
      ...
      notifyApproval: async ({ cfg, id }: { cfg: any; id: string }) => {
        ...
        await sendMessage(
          account.incomingUrl,
          "Genoma: your access has been approved.",
          id,
    ...
    security: {
      resolveDmPolicy: ({
        ...
        return {
          ...
          approveHint: "genoma pairing approve synology-chat <code>",
