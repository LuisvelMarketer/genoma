...
Official Voice Call plugin for **Genoma**.
...
Docs: `https://docs.genoma.ai/plugins/voice-call`
Plugin system: `https://docs.genoma.ai/plugin`

## Install (local dev)

### Option A: install via Genoma (recommended)
...
```bash
mkdir -p ~/.genoma/extensions
cp -R extensions/voice-call ~/.genoma/extensions/voice-call
cd ~/.genoma/extensions/voice-call && pnpm install
```
...
```bash
genoma voicecall call --to "+15555550123" --message "Hello from Genoma"
genoma voicecall continue --call-id <id> --message "Any questions?"
genoma voicecall speak --call-id <id> --message "One moment"
genoma voicecall end --call-id <id>
genoma voicecall status --call-id <id>
genoma voicecall tail
