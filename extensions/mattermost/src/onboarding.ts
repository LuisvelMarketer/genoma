import type { ChannelOnboardingAdapter, GenomaConfig, WizardPrompter } from "genoma/plugin-sdk";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "genoma/plugin-sdk/account-id";
import {
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.genoma.ai/channels/mattermost",
    ].join("\n"),
