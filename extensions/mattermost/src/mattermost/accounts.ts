...
export function listMattermostAccountIds(cfg: GenomaConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: GenomaConfig): string {
...
export function listEnabledMattermostAccounts(cfg: GenomaConfig): ResolvedMattermostAccount[] {
