...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: GenomaConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: GenomaConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: GenomaConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: GenomaConfig }): Promise<void> {
