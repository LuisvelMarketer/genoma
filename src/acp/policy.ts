...
export function isAcpEnabledByPolicy(cfg: GenomaConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: GenomaConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: GenomaConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: GenomaConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: GenomaConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: GenomaConfig, agentId: string): boolean {
