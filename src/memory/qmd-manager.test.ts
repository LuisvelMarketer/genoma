...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: GenomaConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: GenomaConfig }) {
  ...
  afterEach(() => {
    ...
    delete (globalThis as Record<string, unknown>).__genomaMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__genomaMcporterColdStartWarned;
  });
