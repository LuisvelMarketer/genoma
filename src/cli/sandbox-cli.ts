...
const SANDBOX_EXAMPLES = {
  main: [
    ["genoma sandbox list", "List all sandbox containers."],
    ["genoma sandbox list --browser", "List only browser containers."],
    ["genoma sandbox recreate --all", "Recreate all containers."],
    ["genoma sandbox recreate --session main", "Recreate a specific session."],
    ["genoma sandbox recreate --agent mybot", "Recreate agent containers."],
    ["genoma sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["genoma sandbox list", "List all sandbox containers."],
    ["genoma sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["genoma sandbox recreate --all", "Recreate all containers."],
    ["genoma sandbox recreate --session main", "Recreate a specific session."],
    ["genoma sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["genoma sandbox recreate --browser --all", "Recreate only browser containers."],
    ["genoma sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["genoma sandbox explain", "Show effective sandbox config."],
    ["genoma sandbox explain --session agent:main:main", "Explain a specific session."],
    ["genoma sandbox explain --agent work", "Explain an agent sandbox."],
    ["genoma sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.genoma.ai/cli/sandbox")}\n`,
    )
    .action(() => {
