const DEFAULT_TAGLINE = "All your chats, one Genome.";
...
const TAGLINES: string[] = [
  "Your terminal just evolved—type something and let the agent handle the busywork.",
  ...
  "Automation with DNA: minimal fuss, maximal evolution.",
  ...
  "Genes out, commit in—let's ship something mildly responsible.",
  "Your workflow, evolved: secure, efficient, autonomous.",
  "Shell yeah—I'm here to automate the toil and leave you the glory.",
  ...
  "The only agent in your contacts that actually evolves. 🧬",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.GENOMA_TAGLINE_INDEX;
