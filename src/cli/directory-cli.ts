    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["genoma directory self --channel slack", "Show the connected account identity."],
          [
            'genoma directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["genoma directory groups list --channel discord", "List available groups/channels."],
          [
            "genoma directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.genoma.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
