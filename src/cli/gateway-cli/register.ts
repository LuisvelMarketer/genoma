      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["genoma gateway run", "Run the gateway in the foreground."],
            ["genoma gateway status", "Show service status and probe reachability."],
            ["genoma gateway discover", "Find local and wide-area gateway beacons."],
            ["genoma gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.genoma.ai/cli/gateway")}\n`,
      ),
  );
