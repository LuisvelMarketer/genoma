    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["genoma channels list", "List configured channels and auth profiles."],
          ["genoma channels status --probe", "Run channel status checks and probes."],
          [
            "genoma channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["genoma channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.genoma.ai/cli/channels",
        )}\n`,
    );
