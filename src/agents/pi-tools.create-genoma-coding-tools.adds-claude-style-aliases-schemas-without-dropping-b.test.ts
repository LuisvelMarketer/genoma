...
const defaultTools = createGenomaCodingTools({ senderIsOwner: true });
...
describe("createGenomaCodingTools", () => {
  ...
  it("enforces apply_patch availability and canonical names across model/provider constraints", () => {
    ...
    const enabledConfig: GenomaConfig = {
      tools: {
        exec: {
    ...
    const openAiTools = createGenomaCodingTools({
    ...
    const anthropicTools = createGenomaCodingTools({
      config: enabledConfig,
    ...
    const allowModelsConfig: GenomaConfig = {
      tools: {
        exec: {
    ...
    const allowed = createGenomaCodingTools({
    ...
    const denied = createGenomaCodingTools({
      config: allowModelsConfig,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
    ...
    const oauthTools = createGenomaCodingTools({
      modelProvider: "anthropic",
      modelAuthMode: "oauth",
    });
