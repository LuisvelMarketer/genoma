...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): GenomaConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: GenomaConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: GenomaConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
