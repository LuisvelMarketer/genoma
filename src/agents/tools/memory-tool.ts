...
function resolveMemoryToolContext(options: { config?: GenomaConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: GenomaConfig): MemoryCitationsMode {
