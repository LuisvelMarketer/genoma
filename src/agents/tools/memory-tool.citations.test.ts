...
function asGenomaConfig(config: Partial<GenomaConfig>): GenomaConfig {
  return config as GenomaConfig;
}

function createToolConfig() {
  return asGenomaConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: GenomaConfig = createToolConfig()) {
