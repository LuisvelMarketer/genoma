...
function resolveAvatarSource(cfg: GenomaConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: GenomaConfig, agentId: string): AgentAvatarResolution {
