...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolveGenomaAgentDir();
 ...
 * a hint.
 *
 * See: https://github.com/genoma/genoma/issues/17328
 */
const LOCAL_PROVIDER_HINTS: Record<string, string> = {
  ollama:
    "Ollama requires authentication to be registered as a provider. " +
    'Set OLLAMA_API_KEY="ollama-local" (any value works) or run "genoma configure". ' +
    "See: https://docs.genoma.ai/providers/ollama",
  vllm:
    "vLLM requires authentication to be registered as a provider. " +
    'Set VLLM_API_KEY (any value works) or run "genoma configure". ' +
    "See: https://docs.genoma.ai/providers/vllm",
};
