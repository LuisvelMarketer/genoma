...
export const DEFAULT_SANDBOX_IMAGE = "genoma-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "genoma-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "genoma-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "genoma-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "genoma-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "genoma-sandbox-browser";
