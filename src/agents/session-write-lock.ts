...
const CLEANUP_STATE_KEY = Symbol.for("genoma.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("genoma.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("genoma.sessionWriteLockWatchdogState");
