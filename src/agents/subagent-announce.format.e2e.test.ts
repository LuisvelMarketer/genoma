...
describe("subagent announce formatting", () => {
  ...
  beforeAll(async () => {
    ...
    // See: https://github.com/genoma/genoma/issues/31298
    previousFastTestEnv = process.env.GENOMA_TEST_FAST;
  ...
  afterAll(() => {
    if (previousFastTestEnv === undefined) {
      delete process.env.GENOMA_TEST_FAST;
      return;
    }
    process.env.GENOMA_TEST_FAST = previousFastTestEnv;
  });

  beforeEach(() => {
    // GENOMA_TEST_FAST is set in beforeAll before module import
  ...
  it("sends instructional message to main agent with status and findings", async () => {
    ...
    expect(msg).toContain("Genoma runtime context (internal):");
