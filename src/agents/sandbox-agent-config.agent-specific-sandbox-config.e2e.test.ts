...
async function resolveContext(config: GenomaConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): GenomaConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
