...
function resolveWatchPaths(workspaceDir: string, config?: GenomaConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: GenomaConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: GenomaConfig }) {
