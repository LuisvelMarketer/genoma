...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.GENOMA_TTS_PREFS;
      process.env.GENOMA_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.GENOMA_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: GenomaConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
