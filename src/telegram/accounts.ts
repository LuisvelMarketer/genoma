...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.GENOMA_DEBUG_TELEGRAM_ACCOUNTS)) {
...
function listConfiguredAccountIds(cfg: GenomaConfig): string[] {
...
export function listTelegramAccountIds(cfg: GenomaConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: GenomaConfig): string {
...
function mergeTelegramAccountConfig(cfg: GenomaConfig, accountId: string): TelegramAccountConfig {
  const {
    accounts: _ignored,
  ...
  // See: https://github.com/genoma/genoma/issues/30673
...
export function listEnabledTelegramAccounts(cfg: GenomaConfig): ResolvedTelegramAccount[] {
