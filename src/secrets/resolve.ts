...
function resolveResolutionLimits(config: GenomaConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: GenomaConfig): SecretProviderConfig {
