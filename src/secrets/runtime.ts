...
type SecretDefaults = NonNullable<GenomaConfig["secrets"]>["defaults"];
...
function collectCandidateAgentDirs(config: GenomaConfig): string[] {
  const dirs = new Set<string>();
  dirs.add(resolveUserPath(resolveGenomaAgentDir()));
