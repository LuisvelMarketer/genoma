...
export const PLUGIN_MANIFEST_FILENAME = "genoma.plugin.json";
...
// package.json "genoma" metadata (used for onboarding/catalog)
...
export type GenomaPackageManifest = {
  extensions?: string[];
...
): GenomaPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
