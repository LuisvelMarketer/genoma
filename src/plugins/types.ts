...
export type GenomaPluginConfigSchema = {
...
export type GenomaPluginToolContext = {
  config?: GenomaConfig;
  workspaceDir?: string;
  agentDir?: string;
  agentId?: string;
...
export type GenomaPluginToolFactory = (
  ctx: GenomaPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type GenomaPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type GenomaPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<GenomaConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type GenomaPluginGatewayMethod = {
  method: string;
 ...
 */
export type GenomaPluginCommandDefinition = {
...
export type GenomaPluginHttpRouteAuth = "gateway" | "plugin";
export type GenomaPluginHttpRouteMatch = "exact" | "prefix";

export type GenomaPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean | void> | boolean | void;

export type GenomaPluginHttpRouteParams = {
  path: string;
  handler: GenomaPluginHttpRouteHandler;
  auth: GenomaPluginHttpRouteAuth;
  match?: GenomaPluginHttpRouteMatch;
  replaceExisting?: boolean;
};

export type GenomaPluginCliContext = {
  program: Command;
  config: GenomaConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type GenomaPluginCliRegistrar = (ctx: GenomaPluginCliContext) => void | Promise<void>;

export type GenomaPluginServiceContext = {
  config: GenomaConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type GenomaPluginService = {
  id: string;
  start: (ctx: GenomaPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: GenomaPluginServiceContext) => void | Promise<void>;
};

export type GenomaPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type GenomaPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: GenomaPluginConfigSchema;
  register?: (api: GenomaPluginApi) => void | Promise<void>;
  activate?: (api: GenomaPluginApi) => void | Promise<void>;
};

export type GenomaPluginModule =
  | GenomaPluginDefinition
  | ((api: GenomaPluginApi) => void | Promise<void>);

export type GenomaPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | GenomaPluginToolFactory,
    opts?: GenomaPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: GenomaPluginHookOptions,
  ) => void;
  registerHttpRoute: (params: GenomaPluginHttpRouteParams) => void;
  registerChannel: (registration: GenomaPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: GenomaPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: GenomaPluginService) => void;
   ...
   */
  registerCommand: (command: GenomaPluginCommandDefinition) => void;
