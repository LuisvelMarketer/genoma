...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/genoma/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/genoma/extensions",
        global: "/Users/x/.genoma/extensions",
        workspace: "/Users/x/ws/.genoma/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.genoma/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/genoma/extensions",
        global: "/Users/x/.genoma/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.genoma/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/genoma/extensions",
        global: "/Users/x/.genoma/extensions",
