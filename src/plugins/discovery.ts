...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @genoma/voice-call -> voice-call).
...
export function discoverGenomaPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ownershipUid?: number | null;
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".genoma", "extensions")];
