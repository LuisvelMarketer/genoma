...
export function listWhatsAppAuthDirs(cfg: GenomaConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: GenomaConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: GenomaConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: GenomaConfig): ResolvedWhatsAppAccount[] {
