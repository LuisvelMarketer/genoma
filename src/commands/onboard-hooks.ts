...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.genoma.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("genoma hooks list")}`,
      `  ${formatCliCommand("genoma hooks enable <name>")}`,
      `  ${formatCliCommand("genoma hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
