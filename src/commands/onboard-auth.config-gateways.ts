...
export function applyVercelAiGatewayProviderConfig(cfg: GenomaConfig): GenomaConfig {
...
export function applyVercelAiGatewayConfig(cfg: GenomaConfig): GenomaConfig {
