...
const ensureGenomaModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveGenomaAgentDir = vi.fn().mockReturnValue("/tmp/genoma-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/genoma-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureGenomaModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveGenomaAgentDir,
}));
