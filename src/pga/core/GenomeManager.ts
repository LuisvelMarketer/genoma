    ...
    private createDefaultC0(): Chromosome0 {
        return {
            identity: {
                ...
                purpose: 'Help users accomplish their tasks efficiently while continuously learning and improving.',
                constraints: [
            ...
            operations: [
                {
                    id: generateUUID(),
                    category: 'tool-usage',
                    content: 'Use tools efficiently and appropriately for each task. Prefer specialized tools over general approaches.',
                    fitness: this.createDefaultFitness(),
                    origin: 'initial',
                    usageCount: 0,
                    lastUsed: now,
                ...
                },
                {
                    id: generateUUID(),
                    category: 'reasoning',
                    content: 'Think step by step. Break complex problems into smaller parts. Verify assumptions.',
                    fitness: this.createDefaultFitness(),
                    origin: 'initial',
                    usageCount: 0,
                    lastUsed: now,
                ...
                },
                {
                    ...
                    content: 'Handle errors gracefully. Provide helpful error messages. Suggest recovery actions.',
                    fitness: this.createDefaultFitness(),
                    origin: 'initial',
                    usageCount: 0,
                    lastUsed: now,
