...
import { type GenomaConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: GenomaConfig): string[] {
...
export function listAgentsForGateway(cfg: GenomaConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: GenomaConfig): string {
...
function resolveSessionStoreAgentId(cfg: GenomaConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: GenomaConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: GenomaConfig): GatewaySessionsDefaults {
