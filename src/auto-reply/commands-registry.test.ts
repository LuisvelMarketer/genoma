...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@genoma", { botUsername: "genoma" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@genoma args", {
        botUsername: "genoma",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "genoma" })).toBe(
      "/help@otherbot",
    );
  });
