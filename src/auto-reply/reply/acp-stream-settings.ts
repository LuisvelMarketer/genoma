...
function resolveAcpStreamCoalesceIdleMs(cfg: GenomaConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: GenomaConfig): number {
...
export function resolveAcpProjectionSettings(cfg: GenomaConfig): AcpProjectionSettings {
