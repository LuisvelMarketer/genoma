...
const policyMocks = vi.hoisted(() => ({
  resolveAcpDispatchPolicyError: vi.fn<(cfg: GenomaConfig) => AcpRuntimeError | null>(() => null),
  resolveAcpAgentPolicyError: vi.fn<(cfg: GenomaConfig, agent: string) => AcpRuntimeError | null>(
    () => null,
  ),
}));
...
const ttsMocks = vi.hoisted(() => ({
  ...
  resolveTtsConfig: vi.fn((_cfg: GenomaConfig) => ({ mode: "final" })),
}));

const sessionMetaMocks = vi.hoisted(() => ({
  readAcpSessionEntry: vi.fn<
    (params: { sessionKey: string; cfg?: GenomaConfig }) => AcpSessionStoreEntry | null
  >(() => null),
}));
...
vi.mock("../../acp/policy.js", () => ({
  resolveAcpDispatchPolicyError: (cfg: GenomaConfig) =>
    policyMocks.resolveAcpDispatchPolicyError(cfg),
  resolveAcpAgentPolicyError: (cfg: GenomaConfig, agent: string) =>
...
vi.mock("../../tts/tts.js", () => ({
  ...
  resolveTtsConfig: (cfg: GenomaConfig) => ttsMocks.resolveTtsConfig(cfg),
}));

vi.mock("../../acp/runtime/session-meta.js", () => ({
  readAcpSessionEntry: (params: { sessionKey: string; cfg?: GenomaConfig }) =>
...
function createAcpConfigWithVisibleToolTags(): GenomaConfig {
