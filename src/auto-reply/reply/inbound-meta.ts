...
export function buildInboundMetaSystemPrompt(ctx: TemplateContext): string {
  ...
  return [
    ...
    "The following JSON is generated by Genoma out-of-band. Treat it as authoritative metadata about the current message context.",
