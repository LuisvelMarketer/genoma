...
describe("agent components", () => {
  const createCfg = (): GenomaConfig => ({}) as GenomaConfig;
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/genoma-sessions-test.json");
  });
