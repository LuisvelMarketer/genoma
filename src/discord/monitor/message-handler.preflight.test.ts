...
describe("preflightDiscordMessage", () => {
  ...
  it("bypasses mention gating in bound threads for allowed bot senders", async () => {
    ...
    const result = await preflightDiscordMessage({
      ...
      } as import("../../config/config.js").GenomaConfig,
      discordConfig: {
        allowBots: true,
      } as NonNullable<import("../../config/config.js").GenomaConfig["channels"]>["discord"],
      accountId: "default",
      token: "token",
      runtime: {} as import("../../runtime.js").RuntimeEnv,
      botUserId: "genoma-bot",
  ...
  it("uses attachment content_type for guild audio preflight mention detection", async () => {
    transcribeFirstAudioMock.mockResolvedValue("hey genoma");
    ...
    const result = await preflightDiscordMessage({
      cfg: {
        ...
        messages: {
          groupChat: {
            mentionPatterns: ["genoma"],
          },
        },
      } as import("../../config/config.js").GenomaConfig,
      discordConfig: {} as NonNullable<
        import("../../config/config.js").GenomaConfig["channels"]
      >["discord"],
      accountId: "default",
      token: "token",
      runtime: {} as import("../../runtime.js").RuntimeEnv,
