...
function mergeDiscordAccountConfig(cfg: GenomaConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: GenomaConfig): ResolvedDiscordAccount[] {
