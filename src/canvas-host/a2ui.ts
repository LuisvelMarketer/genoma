...
export const A2UI_PATH = "/__genoma__/a2ui";

export const CANVAS_HOST_PATH = "/__genoma__/canvas";

export const CANVAS_WS_PATH = "/__genoma__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.genomaCanvasA2UIAction.postMessage(...)
  // - Android: window.genomaCanvasA2UIAction.postMessage(...)
  const handlerNames = ["genomaCanvasA2UIAction"];
  ...
  globalThis.Genoma = globalThis.Genoma ?? {};
  globalThis.Genoma.postMessage = postToNode;
  globalThis.Genoma.sendUserAction = sendUserAction;
  globalThis.genomaPostMessage = postToNode;
  globalThis.genomaSendUserAction = sendUserAction;
