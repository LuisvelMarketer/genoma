...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.genoma.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", GENOMA_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.genoma.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when GENOMA_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.genoma.gateway.plist",
    },
    {
      name: "uses profile-specific label when GENOMA_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", GENOMA_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.genoma.jbphoenix.plist",
    },
    {
      name: "prefers GENOMA_LAUNCHD_LABEL over GENOMA_PROFILE",
      env: {
        HOME: "/Users/test",
        GENOMA_PROFILE: "jbphoenix",
        GENOMA_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from GENOMA_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        GENOMA_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty GENOMA_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        GENOMA_PROFILE: "myprofile",
        GENOMA_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.genoma.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
