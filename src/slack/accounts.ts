...
function mergeSlackAccountConfig(cfg: GenomaConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: GenomaConfig): ResolvedSlackAccount[] {
