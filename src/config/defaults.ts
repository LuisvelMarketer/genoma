...
function resolveAnthropicDefaultAuthMode(cfg: GenomaConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: GenomaConfig): GenomaConfig {
...
export function applyTalkApiKey(config: GenomaConfig): GenomaConfig {
...
export function applyTalkConfigNormalization(config: GenomaConfig): GenomaConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: GenomaConfig): GenomaConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: GenomaConfig): GenomaConfig {
...
export function applyLoggingDefaults(cfg: GenomaConfig): GenomaConfig {
...
export function applyContextPruningDefaults(cfg: GenomaConfig): GenomaConfig {
...
export function applyCompactionDefaults(cfg: GenomaConfig): GenomaConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
