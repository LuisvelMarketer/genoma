...
export function createAccountListHelpers(channelKey: string) {
  function resolveConfiguredDefaultAccountId(cfg: GenomaConfig): string | undefined {
  ...
  function listAccountIds(cfg: GenomaConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: GenomaConfig): string {
