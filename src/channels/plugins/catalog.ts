...
import { discoverGenomaPlugins } from "../../plugins/discovery.js";
import type { GenomaPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, GenomaPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["GENOMA_PLUGIN_CATALOG_PATHS", "GENOMA_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<GenomaPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: GenomaPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: GenomaPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverGenomaPlugins({ workspaceDir: options.workspaceDir });
