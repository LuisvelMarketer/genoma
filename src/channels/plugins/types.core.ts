...
export type ChannelAgentToolFactory = (params: { cfg?: GenomaConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: GenomaConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: GenomaConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: GenomaConfig }) => boolean;
  supportsCards?: (params: { cfg: GenomaConfig }) => boolean;
