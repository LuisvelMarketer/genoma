...
export function listChannelMessageActions(cfg: GenomaConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: GenomaConfig): boolean {
...
export function supportsChannelMessageCards(cfg: GenomaConfig): boolean {
