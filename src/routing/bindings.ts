...
export function listBindings(cfg: GenomaConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: GenomaConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: GenomaConfig) {
