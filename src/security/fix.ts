...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof GenomaConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: GenomaConfig; env: NodeJS.ProcessEnv }): {
  cfg: GenomaConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
