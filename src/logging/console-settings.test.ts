...
let originalGenomaTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalGenomaTestConsole = process.env.GENOMA_TEST_CONSOLE;
  process.env.GENOMA_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalGenomaTestConsole === undefined) {
    delete process.env.GENOMA_TEST_CONSOLE;
  } else {
    process.env.GENOMA_TEST_CONSOLE = originalGenomaTestConsole;
  }
