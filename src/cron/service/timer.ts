...
export async function onTimer(state: CronServiceState) {
  if (state.running) {
    ...
    // execution to finish.
    // See: https://github.com/genoma/genoma/issues/12025
...
> {
    ...
    if (job.wakeMode === "now" && state.deps.runHeartbeatOnce) {
      ...
      for (;;) {
        ...
        heartbeatResult = await state.deps.runHeartbeatOnce({
          ...
          // See: https://github.com/genoma/genoma/issues/28508
  ...
  // See: https://github.com/genoma/genoma/issues/15692
  //
  ...
  // See: https://github.com/genoma/genoma/issues/32013
