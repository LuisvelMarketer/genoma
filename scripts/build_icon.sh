...
# Defaults target the Genoma assets so you can just run the script from repo root.
...
DEST_ICNS=${DEST_ICNS:-"$ROOT_DIR/apps/macos/Sources/Genoma/Resources/Genoma.icns"}
