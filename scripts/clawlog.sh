...
show_usage() {
    cat << EOF
clawlog - Genoma Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Genoma logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Genoma logs flow through the macOS unified log (subsystem: ai.genoma).
