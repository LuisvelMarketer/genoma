...
# Output:
# - dist/Genoma.app
# - dist/Genoma-<version>.zip
# - dist/Genoma-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.genoma.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/Genoma.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Genoma-$VERSION.zip"
DMG="$ROOT_DIR/dist/Genoma-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Genoma-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Genoma-$VERSION.dSYM.zip"
