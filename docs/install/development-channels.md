...
Genoma ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Genoma also aligns
the install method:
...
When you switch channels with `genoma update`, Genoma also syncs plugin sources:
