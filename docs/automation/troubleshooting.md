...
genoma system heartbeat last
genoma logs --follow
genoma config get agents.defaults.heartbeat
genoma channels status --probe
```
...
```bash
genoma config get agents.defaults.heartbeat.activeHours
genoma config get agents.defaults.heartbeat.activeHours.timezone
genoma config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
genoma cron list
genoma logs --follow
```
