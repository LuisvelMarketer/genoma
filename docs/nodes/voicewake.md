...
Genoma treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.genoma/settings/voicewake.json`

Shape:

```json
{ "triggers": ["genoma", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
