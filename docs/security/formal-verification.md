...
summary: Machine-checked security models for Genoma’s highest-risk paths.
read_when:
...
This page tracks Genoma’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that Genoma enforces its
...
**What this is not (yet):** a proof that “Genoma is secure in all respects” or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/genoma-formal-models](https://github.com/vignesh07/genoma-formal-models).
...
```bash
git clone https://github.com/vignesh07/genoma-formal-models
cd genoma-formal-models
