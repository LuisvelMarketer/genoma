---
summary: "VPS hosting hub for Genoma (Oracle/Fly/Hetzner/GCP/exe.dev)"
read_when:
...
- `GENOMA_NO_RESPAWN=1` avoids extra startup overhead from a self-respawn path.
...
- Add service env for stable startup path:
  - `GENOMA_NO_RESPAWN=1`
  - `NODE_COMPILE_CACHE=/var/tmp/genoma-compile-cache`
