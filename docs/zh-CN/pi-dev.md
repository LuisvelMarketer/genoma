...
本指南总结了在 Genoma 中开发 Pi 集成的合理工作流程。
...
状态存储在 Genoma 状态目录下。默认为 `~/.genoma`。如果设置了 `GENOMA_STATE_DIR`，则使用该目录。
...
- https://docs.genoma.ai/testing
- https://docs.genoma.ai/start/getting-started
