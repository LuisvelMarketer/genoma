...
read_when:
  - You are building a Genoma plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (genoma.plugin.json)

Every plugin **must** ship a `genoma.plugin.json` file in the **plugin root**.
Genoma uses this manifest to validate configuration **without executing plugin
