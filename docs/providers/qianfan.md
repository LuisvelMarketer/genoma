---
summary: "Use Qianfan's unified API to access many models in Genoma"
read_when:
...
3. Genoma installed on your system
...
4. Copy the API key for use with Genoma

## CLI setup

```bash
genoma onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Genoma Configuration](/gateway/configuration)
