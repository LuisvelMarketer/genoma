---
summary: "Use Kilo Gateway's unified API to access many models in Genoma"
read_when:
  - You want a single API key for many LLMs
  - You want to run models via Kilo Gateway in Genoma
---
...
```bash
genoma onboard --kilocode-api-key <key>
```
