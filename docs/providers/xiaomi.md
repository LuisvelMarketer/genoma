---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Genoma"
read_when:
  - You want Xiaomi MiMo models in Genoma
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Genoma uses
