---
summary: "Use Qwen OAuth (free tier) in Genoma"
read_when:
  - You want to use Qwen with Genoma
...
If you already logged in with the Qwen Code CLI, Genoma will sync credentials
