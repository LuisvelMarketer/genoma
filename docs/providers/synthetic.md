---
summary: "Use Synthetic's Anthropic-compatible API in Genoma"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Genoma registers it as the
...
Note: Genoma's Anthropic client appends `/v1` to the base URL, so use
