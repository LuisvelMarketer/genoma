---
summary: "Use NVIDIA's OpenAI-compatible API in Genoma"
read_when:
  - You want to use NVIDIA models in Genoma
...
genoma onboard --auth-choice skip
genoma models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
