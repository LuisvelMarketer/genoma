---
summary: "First-run onboarding flow for Genoma (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Genoma">
...
<Step title="CLI">
  ...
  The app can install the global `genoma` CLI via npm/pnpm so terminal
