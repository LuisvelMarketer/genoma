---
summary: "Overview of Genoma onboarding options and flows"
read_when:
...
Genoma supports multiple onboarding paths depending on where the Gateway runs
...
- [`genoma onboard` command](/cli/onboard)

## macOS app onboarding

Use the Genoma app when you want a fully guided setup on macOS. Docs:
