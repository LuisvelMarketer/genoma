---
summary: "Synology Chat webhook setup and Genoma config"
read_when:
  - Setting up Synology Chat with Genoma
...
```bash
genoma plugins install ./extensions/synology-chat
```
...
3. Point the outgoing webhook URL to your Genoma gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in Genoma.
...
- Pairing approvals work with:
  - `genoma pairing list synology-chat`
  - `genoma pairing approve synology-chat <CODE>`
...
```bash
genoma message send --channel synology-chat --target 123456 --text "Hello from Genoma"
genoma message send --channel synology-chat --target synology-chat:123456 --text "Hello again"
```
