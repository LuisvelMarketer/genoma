...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure Genoma HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `genoma pairing approve slack <code>`.
...
Genoma supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, Genoma falls back to normal delivery for remaining payloads.
