...
- Install via CLI: `genoma plugins install @genoma/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `genoma plugins install ./extensions/zalo`
   - From npm (if published): `genoma plugins install @genoma/zalo`
...
- Approve via:
  - `genoma pairing list zalo`
  - `genoma pairing approve zalo <CODE>`
...
- Example: `genoma message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `genoma channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `genoma logs --follow`
