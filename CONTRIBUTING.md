# Contributing to Genoma

Welcome to the lobster tank! 🦞

## Quick Links

- **GitHub:** https://github.com/genoma/genoma
- **Vision:** [`VISION.md`](VISION.md)
- **Discord:** https://discord.gg/qkhbAGHRBT
- **X/Twitter:** [@steipete](https://x.com/steipete) / [@genoma](https://x.com/genoma)
...
2. **New features / architecture** → Start a [GitHub Discussion](https://github.com/genoma/genoma/discussions) or ask in Discord first
...
- Test locally with your Genoma instance
...
- **Skills**: For skill contributions, head to [ClawHub](https://clawhub.ai/) — the community hub for Genoma skills.
- **Performance**: Optimizing token usage and compaction logic.

Check the [GitHub Issues](https://github.com/genoma/genoma/issues) for "good first issue" labels!

## Maintainers

We're selectively expanding the maintainer team.
If you're an experienced contributor who wants to help shape Genoma's direction — whether through code, docs, or community — we'd like to hear from you.

Being a maintainer is a responsibility, not an honorary title. We expect active, consistent involvement — triaging issues, reviewing PRs, and helping move the project forward.

Still interested? Email contributing@genoma.ai with:

- Links to your PRs on Genoma (if you don't have any, start there first)
...
For issues that don't fit a specific repo, or if you're unsure, email **security@genoma.ai** and we'll route it.
